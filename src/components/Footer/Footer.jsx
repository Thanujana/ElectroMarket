      ...
      <div className="container">
        <div className="row align-items-start">
          ...
          <div className="col-md-6">
            <img src={assets.logo} alt="Electromart Logo" className="footer-logo mb-3" />
            <p>
              Electromart is your one-stop shop for the latest gadgets and electronics.
              We bring you high-quality products at unbeatable prices, ensuring a seamless shopping experience.
            </p>
